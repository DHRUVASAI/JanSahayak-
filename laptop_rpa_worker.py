...
EC2_BASE_URL = "http://3.88.113.30:8080"   # FastAPI on EC2
POLL_INTERVAL = 3                            # seconds between polls
JOB_ENDPOINT  = f"{EC2_BASE_URL}/rpa/get-job"
DONE_ENDPOINT = f"{EC2_BASE_URL}/rpa/complete-job"

# Mock portal served locally (Terminal 2 runs: python -m http.server 3000 in mock_portal/)
LOCAL_PORTAL_BASE = "http://localhost:3000"
